...
传统的渐进式训练
'''
# @Time    : 2022/6/25 14:58
# @Author  : LINYANZHEN
# @File    : MSRN_OLD_PMG.py
...
class MSRN_OLD_PMG(nn.Module):
    def __init__(self, args, conv=common.default_conv):
        super(MSRN_OLD_PMG, self).__init__()
