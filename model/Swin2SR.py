...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
                 ...
                 pretrained_window_size=0, ape=False):
...
class Swin2SR(nn.Module):
    ...
    def __init__(self, args, img_size=384, patch_size=1, in_chans=3,
        ...
        if self.ape:
            ...
            if self.ape:
                ...
                #     [AdaptivePositionEmbedding(embed_dim) for _ in range(self.num_layers)])
    ...
    def forward_features_hf(self, x, step=-1):
        x_size = (x.shape[2], x.shape[3])
        x = self.patch_embed(x)
        # if self.ape:
