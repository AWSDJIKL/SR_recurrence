...
def make_model(args):
    ...
    print("prepare model")
    if args.is_PMG:
        print("HiT_SNG use PMG")
    else:
        print("HiT_SNG")
    return HiT_SNG(args, upscale=args.scale)
...
class HierarchicalTransformerBlock(nn.Module):
    ...
    def check_image_size(self, x, win_size):
        ...
        if mod_pad_h >= h or mod_pad_w >= w:
            ...
            x = F.pad(x, (0, pad_w, 0, pad_h), 'constant')
        else:
            pad_h, pad_w = 0, 0
...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, base_win_size,
                 ...
                 downsample=None, use_checkpoint=False, hier_win_ratios=[0.5, 1, 2, 4, 6, 8],ape=False):
...
class RHTB(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, base_win_size,
                 ...
                 resi_connection='1conv', hier_win_ratios=[0.5, 1, 2, 4, 6, 8],ape=False):
        ...
        self.residual_group = BasicLayer(dim=dim,
                                         ...
                                         hier_win_ratios=hier_win_ratios,ape=ape)
...
class HiT_SNG(nn.Module, PyTorchModelHubMixin):
    ...
    def __init__(self, args, img_size=64, patch_size=1, in_chans=3,
        ...
        for i_layer in range(self.num_layers):
            layer = RHTB(dim=embed_dim,
                         ...
                         hier_win_ratios=hier_win_ratios, ape=self.ape
                         )
    ...
    def forward(self, x, step=-1):
        ...
        if self.upsampler == 'pixelshuffle':
            ...
            res = self.conv_after_body(self.forward_features(x_first, step)) + x_first
