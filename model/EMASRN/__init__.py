...
# @Time    : 2022/12/26 12:24
# @Author  : LINYANZHEN
# @File    : __init__.py
import torch
import torch.nn as nn
from .blocks import ConvBlock, DeconvBlock, MeanShift
from model.EMASRN.deeplabv3_aspp import ASPP
from model.EMASRN.EMANET_EMAU import EMAU


def make_model(args):
    print("prepare model")
    if args.is_PMG:
        print("EMASRN use PMG")
    else:
        print("EMASRN")
    return EMASRN(3, 3, 32, 4, 6, 4)
